package com.example.gighop.service
...
class LocationService : Service() {
    ...
    private val notificationInterval = 15 * 60 * 1000 //15 minutes
    ...
    private fun startLocationUpdates() {
        val locationRequest = LocationRequest.Builder(
            Priority.PRIORITY_HIGH_ACCURACY,              // accuracy priority
                ...
                for (document in documents) {
                    ...
                    if (lat != null && lon != null) {
                        ...
                        if (distance < 100) {
                            ...
                            //Check for 15 min before sending notification for the same object
                            if (currentTime - lastNotificationTime > notificationInterval) {
                                sendNotification(
                                    "$title",
                                    "Live $type event at $subject!"
                                )
    ...
    private fun sendNotification(title: String, content: String) {
        ...
        //Return to Map screen upon click on notification
